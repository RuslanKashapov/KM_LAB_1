...
class AntColonyOptimizer:
    ...
    def fit(self, map_matrix, iterations=100, mode='min', early_stopping_count=100, verbose=True):
        """
        ...
        """
        # if verbose:
        #     print("На {} итерациях...".format(iterations))
        self.map = map_matrix
        start = time.time()
        self._initialize()
        num_equal = 0
        ...
        for i in range(iterations):
            ...
            for ant in range(self.ants):
                current_node = self.set_of_available_nodes[0]
            ...
            # if verbose: print("Лучшее время на итерации {}: {}; длина пути: {} ({}с)"
